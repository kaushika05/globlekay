...
export const Hungarian: Messages = {
  ...
  a3: "Kay's Globle Mod uses this <a>framework</a> to determine what constitutes a valid guess.",
  ...
  a7: "Geography can be a sensitive topic, and some countries' borders are disputed. If you believe a correction should be made, please politely raise an issue on {GitHub} .",
  GameTitle: "A játék",
  ...
  Settings6: "Városok",
  Settings7: "Nyelv",
  Settings8: "Kay's Globle Mod: A városok változat jön nemsokára!",
  Settings9: "Gyakorlás",
