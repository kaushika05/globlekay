...
export const French: Messages = {
  ...
  a3: "Kay's Globle Mod s'appuie sur cette <a>convention</a> afin de déterminer ce qui constitue une tentative valide.",
  ...
  a7: "La géographie peut être un sujet sensible, et certaines frontières sont contestées. Si vous pensez qu'une correction s'impose, s'il vous plait veuillez m'en informer en ouvrant un billet (\"issue\") sur {GitHub}.",
  GameTitle: "Jeu",
  ...
  Settings6: "Villes",
  Settings7: "Langue",
  Settings8: "Kay's Globle Mod: Édition Ville arrive bientôt!",
