...
export const German: Messages = {
  ...
  Footer1: "Mod created by Kaushika Wijerathne. For non-commercial use only.",
  ...
  a3: "Kay's Globle Mod nutzt dieses <a>Framework</a> um zu entscheiden, was ein gültiger Versuch ist.",
  ...
  a7: "Geographie kann ein schwieriges Thema sein, einige Ländergrenzen sind umstritten. Wenn du glaubst, dass eine Änderung notwendig ist, dann öffne bitte höflich ein Issue auf {GitHub}.",
  GameTitle: "Spiel",
  ...
  Settings6: "Städte",
  Settings7: "Sprache",
  Settings8: "Kay's Globle Mod: Städte Edition kommt bald!",
  Settings9: "Üben",
