...
export const Spanish: Messages = {
  ...
  a3: "Kay's Globle Mod utiliza <a>este marco</a> para determinar que constituye un intento válido.",
  ...
  a7: "La geografía puede ser un tema sensible, y las fronteras de algunos países pueden ser disputadas. Si tu crees que una corrección es necesaria, por favor de manera respetuosa plantea la cuestion con {GitHub}.",
  GameTitle: "Juego",
  ...
  Settings6: "Ciudades",
  Settings7: "Idioma",
  Settings8: "Próximamente Kay's Globle Mod Edición de Ciudades",
  Settings9: "Practicar",
