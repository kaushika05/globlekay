...
export const Swedish: Messages = {
  ...
  a3: "Kay's Globle Mod använder detta <a>ramverk</a> för att avgöra vad som är en giltig gissning.",
  ...
  a7: "Geografi kan vara ett känsligt ämne, och vissa länders gränser är ifrågasatta. Om du anser att en korrigering bör göras, vänligen ta upp ett ärende på {GitHub}.",
  GameTitle: "Spel",
  ...
  Settings6: "Städer",
  Settings7: "Språk",
  Settings8: "Kay's Globle Mod: Cities Edition kommer snart!",
  Settings9: "Öva",
